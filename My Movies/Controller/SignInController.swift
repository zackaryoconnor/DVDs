...
class SignInController: SignInSignUpUIContoller {
    ...
    override func viewDidLoad() {
        ...
        setupUI(welcomeLabelText: "Sign In", signInSignUpButtonText: "Sign In", signInSignUpButtonSelector:  #selector(handleSignInUser), needOrAlreadyHaveAccountButtonText: "Don't have an accout? Tap here.", needOrAlreadyHaveAccountButtonSelector: #selector(handleNeedAccountButtonPressed))
    }
